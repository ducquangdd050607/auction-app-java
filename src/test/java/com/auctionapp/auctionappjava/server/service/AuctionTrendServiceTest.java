...
import com.auctionapp.auctionappjava.server.service.trend.FrequencyAnalyzer;
...
class AuctionTrendServiceTest {
  ...
  private com.auctionapp.auctionappjava.server.service.trend.AuctionTrendContext context(
      Auction auction, LocalDateTime now) {
    return new com.auctionapp.auctionappjava.server.service.trend.AuctionTrendContext(
