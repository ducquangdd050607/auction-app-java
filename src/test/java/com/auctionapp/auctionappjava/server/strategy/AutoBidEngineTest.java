...
public class AutoBidEngineTest {
  ...
  public void testAutoBidOutbidsManualLeader() {
    ...
    Optional<AutoBidEngine.AutoBidResult> result =
        engine.calculateNextBid(
            List.of(config), new BigDecimal("10"), new BigDecimal("120"), manualLeaderId);
  ...
  public void testNoBidWhenThereIsNoCompetitor() {
    ...
    Optional<AutoBidEngine.AutoBidResult> result =
        engine.calculateNextBid(List.of(config), new BigDecimal("10"), null, null);
  ...
  public void testEarlierConfigWinsWhenMaxBidIsEqual() {
    ...
    Optional<AutoBidEngine.AutoBidResult> result =
        engine.calculateNextBid(
            List.of(second, first), new BigDecimal("10"), new BigDecimal("100"), null);
  ...
  public void testNoAutoBidWhenManualLeaderIsHighest() {
    ...
    Optional<AutoBidEngine.AutoBidResult> result =
        engine.calculateNextBid(
            List.of(config), new BigDecimal("10"), new BigDecimal("220"), manualLeaderId);
  ...
  public void testDefaultIncrementMustBePositive() {
    ...
    assertThrows(
        ...
        () ->
            engine.calculateNextBid(
                List.of(), BigDecimal.ZERO, new BigDecimal("100"), UUID.randomUUID()));
  }
