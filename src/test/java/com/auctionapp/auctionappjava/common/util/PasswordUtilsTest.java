...
class PasswordUtilsTest {
    ...
    void generateSalt_shouldBeRandom() {
        ...
        assertNotEquals(salt1, salt2,
                "Hai lần gọi generateSalt phải cho kết quả khác nhau (tính ngẫu nhiên)");
    }
    ...
    void hashPassword_differentSalts_shouldProduceDifferentHashes() {
        ...
        assertNotEquals(hash1, hash2,
                "Cùng password nhưng salt khác → hash phải khác nhau");
    }
    ...
    void hashPassword_differentPasswords_shouldProduceDifferentHashes() {
        ...
        assertNotEquals(hash1, hash2,
                "Password khác nhau → hash phải khác nhau");
    }
    ...
    void verifyPassword_withCorrectCredentials_shouldReturnTrue() {
        ...
        assertTrue(PasswordUtils.verifyPassword(rawPassword, salt, hash),
    ...
    void verifyPassword_withWrongPassword_shouldReturnFalse() {
        ...
        assertFalse(PasswordUtils.verifyPassword("wrongPassword", salt, hash),
    ...
    void verifyPassword_withWrongSalt_shouldReturnFalse() {
        ...
        assertFalse(PasswordUtils.verifyPassword("password", "wrong-salt", hash),
