...
public class AccountController implements Initializable {
  ...
  public void loadAccountData() {
    ...
    lblBalance.setText(
        formatMoney(UserSession.getInstance().getCurrentUser().walletBalance()) + " VND");
  }
  ...
  void handleChangingInformation(ActionEvent event) throws IOException {
    SceneSwitcherUtils.PopupController(
        event,
        "/com/auctionapp/auctionappjava/views/ChangeInformationScreen.fxml",
        "Thay đổi thông tin");
    loadAccountData();
  }
  ...
  void handleDeposit(ActionEvent event) throws IOException {
    SceneSwitcherUtils.PopupController(
        event, "/com/auctionapp/auctionappjava/views/DepositScreen.fxml", "Nạp tiền");
    loadAccountData();
  }
  ...
  void handleChangePassword(ActionEvent event) throws IOException {
    SceneSwitcherUtils.PopupController(
        event, "/com/auctionapp/auctionappjava/views/ChangePasswordScreen.fxml", "Đổi mật khẩu");
  }
