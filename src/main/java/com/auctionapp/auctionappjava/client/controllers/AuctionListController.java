...
public class AuctionListController implements Initializable {
  ...
  private final ObservableList<AuctionSummaryResponse> auctionData =
  ...
  @FXML private TableColumn<AuctionSummaryResponse, String> clmName;
  @FXML private TableColumn<AuctionSummaryResponse, String> clmType;
  @FXML private TableColumn<AuctionSummaryResponse, BigDecimal> clmStartPrice;
  @FXML private TableColumn<AuctionSummaryResponse, BigDecimal> clmCurrentPrice;
  @FXML private TableColumn<AuctionSummaryResponse, BigDecimal> clmMinIncrement;
  @FXML private TableColumn<AuctionSummaryResponse, Integer> clmBidders;
  @FXML private TableColumn<AuctionSummaryResponse, String> clmStatus;
  @FXML private TableColumn<AuctionSummaryResponse, String> clmTime; // Thời gian còn lại
  @FXML private TextField txtSearch;
  @FXML private Label txtVersatile;
    ...
    filteredData.setPredicate(
        auction -> {
          ...
          boolean matchName =
              keyword.isEmpty()
                  || (auction.itemName() != null
                      && auction.itemName().toLowerCase().contains(keyword));
          ...
          if (selectedCategory == null || selectedCategory.equals("Tất cả thể loại")) {
            ...
            matchCategory =
                auction.category() != null && auction.category().equalsIgnoreCase(serverCategory);
          }
  ...
  void handleAdd(ActionEvent event) throws IOException {
    FXMLLoader loader =
        new FXMLLoader(
            getClass().getResource("/com/auctionapp/auctionappjava/views/AddItemScreen.fxml"));
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    sortedData
        .comparatorProperty()
        .bind(listAuctions.comparatorProperty()); // Để bảng có thể bấm sort theo cột
              ...
              Platform.runLater(
                  () -> {
                    ...
                    if (response.success()) {
                      ...
                      List<AuctionSummaryResponse> listFromServer =
  ...
  private void handleRemoveAuction(AuctionSummaryResponse auction) throws IOException {
    RemoveAuctionRequest removeReq =
        new RemoveAuctionRequest(
            UserSession.getInstance().getCurrentUser().id(), auction.auctionId());
  ...
  private void setupColumns() {
      ...
      clmTime.setCellValueFactory(
          cell -> {
            ...
            try {
              ...
              if (now.isBefore(startTime)) {
                displayTime =
                    "Diễn ra sau " + formatDuration(java.time.Duration.between(now, startTime));
              }
    ...
    clmStartPrice.setCellValueFactory(
        cell -> new SimpleObjectProperty<>(cell.getValue().startPrice()));
    ...
    if (clmMinIncrement != null) {
      clmMinIncrement.setCellValueFactory(
          cell -> new SimpleObjectProperty<>(cell.getValue().minimumIncrement()));
    }
    ...
    if (clmBidders != null) {
      ...
      clmBidders.setCellValueFactory(
          cell -> new SimpleObjectProperty<>(cell.getValue().bidderCount()));
    }
  }
  ...
  public void setMode(String mode) {
    ...
    if (Objects.equals(mode, "Danh sách đấu giá")) {
      txtVersatile.setText("Blue88 Thông tin sản phẩm");
    } else if (Objects.equals(mode, "Quản lý vật phẩm")) {
      txtVersatile.setText("Blue88 Quản lý sản phẩm");
    } else if (Objects.equals(mode, "Quản lý phiên đấu giá")) {
      txtVersatile.setText("Blue88 Quản lý phiên đấu giá");
    }
  }

  private void setupRowDoubleClick() {
    listAuctions.setRowFactory(
        tv -> {
    ...
    Image warningImage =
        new Image(
            Objects.requireNonNull(
                getClass()
                    .getResourceAsStream("/com/auctionapp/auctionappjava/images/Koconut.png")));
        ...
        () -> {
          ...
          for (int i = 0; i < auctionData.size(); i++) {
            ...
            if (currentItem.auctionId().equals(auctionId.toString())) {
              ...
              AuctionSummaryResponse updatedItem =
