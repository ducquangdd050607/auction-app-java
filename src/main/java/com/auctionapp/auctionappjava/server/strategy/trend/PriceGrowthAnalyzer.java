  ...
  public TrendSignal analyze(AuctionTrendContext context) {
    ...
    if (transactions.size() < 2) {
      return new TrendSignal(
          BigDecimal.ONE, BigDecimal.ONE, "Bình thường", "Chưa có biến động giá");
    }
    ...
    BigDecimal displayPercent =
        growthPercent.multiply(new BigDecimal("100")).setScale(1, RoundingMode.HALF_UP);
