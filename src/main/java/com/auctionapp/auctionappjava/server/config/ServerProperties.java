...
public final class ServerProperties {
  ...
  public static final String DB_USER =
      System.getProperty("auction.db.user", "3o8AnK1TAtQ7Tbu.root");
  ...
  public static final String DB_PASSWORD =
      System.getProperty("auction.db.password", "f1bADPyWrfHl5k3M");
   ...
   */
  public static final int SERVER_PORT = Integer.getInteger("auction.server.port", 8080);
