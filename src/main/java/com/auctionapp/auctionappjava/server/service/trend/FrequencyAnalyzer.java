...
public class FrequencyAnalyzer implements AuctionActivityAnalyzer {
  ...
  public TrendSignal analyze(AuctionTrendContext context) {
    ...
    long timeGapSeconds = Duration.between(startTime, endTime).dividedBy(10).toSeconds();
    ...
    return new TrendSignal(
        cappedRatio, freqCoeff, status, recentBids + " bid trong thời gian gần đây");
  }
}
